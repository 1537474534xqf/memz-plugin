...
| 清空Redis    | #Redis一键清空(dbx) | 清空Redis        | 慎重哈                 | Master              |

### QQ功能

| 功能           | 命令正则  | 功能描述          | 备注              | 权限                |
| -------------- | --------- | ----------------- | ----------------- | ------------------- |
| 查询QQ注册时间 | #查q龄    | 查询QQ注册时间    | 可@ 也可直接+QQ号 | Master & 可开放权限 |
| 全体假禁言     | #全体假禁 | 全体禁言,但是假的 | 有什么用呢......? | Master              |
...
| 一键打卡         | #一键打卡                   | 群聊打卡                                | 无                          | Master |
| 群发             | #一键群发+内容              | 群发                                    | 无                          | Master |
